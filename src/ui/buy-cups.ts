...
export class BuyCups extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number) {
        ...
        this.firstOption = new ItemPurchaseContainer(scene, 0, 0, itemName, 75, 1);
        this.secondOption = new ItemPurchaseContainer(scene, 0, 50, itemName, 225, 2.35);
        this.thirdOption = new ItemPurchaseContainer(scene, 0, 100, itemName, 400, 3.75);
