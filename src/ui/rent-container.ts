...
export class RentContainer extends Phaser.GameObjects.Container {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number) {
    ...
    // load locations
    const suburb = new Location('The Suburbs', 'Kids love lemonade!', "Is there a better place to start your Lemonade empire than your very own neighborhood? Don't expect a lot of customeres here, but the free rent and popularity bonus will help you test...", 0, 0, 0);
    const park = new Location('The Park', 'Kids love lemonade!', "With a decent customer base and a fairly cheap daily rent, the park is a nice place to start expanding your business. Kids just can't resist a cool glass of lemonade, so long as you keep...", 10, 0,0);
